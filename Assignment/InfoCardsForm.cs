...
namespace Assignment
{
    ...
    {
        private const int NodeRoot = -1;
        private const int NodeCategory = -2;
        private const string InfoCardsFile = "infocards.txt";
        private IInfoCards _infoCards = null;
        private Dictionary<string, IInfoCardFactory> _infoCardFactories;
        private IInfoCard _lastDisplayedCard = null;
        ...
        private void PopulateTreeView(string selectedKey)
        {
            ...
            {
                IInfoCard infoCard = _infoCards[i];
